...
type FormData = Pick<TUserSchema, 'password' | 'confirm_password' | 'new_password'>
...
export default function ChangePassword() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      const res = await updateProfileMutation.mutateAsync(omit(data, ['confirm_password'] as any))
